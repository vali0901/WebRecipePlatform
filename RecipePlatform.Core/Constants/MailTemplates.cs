namespace RecipePlatform.Core.Constants;
...
<body>
            ...
            <tr style=""height: 102px;"">
                <td style=""background: #ffffff; color: #000000; height: 29px; width: 660px;"" align=""center"" valign=""top"" bgcolor=""#ffffff"">
                    <table style=""border-top: 2px solid #3c87be; width: 660px;"" border=""0"" cellspacing=""0"" cellpadding=""0"">
                        <tbody>
                            <tr>
                                <td>Welcome to Our Vegan Recipe Platform! We can't wait you to share your creativity with us! Good Cooking!</td>
                            </tr>
                        </tbody>
                    </table>
                </td>
    ...
    public static string UserUpdateTemplate(string name) => $@"<!DOCTYPE html>
<html lang=""en"" xmlns=""http://www.w3.org/1999/xhtml"">
<head>
    <meta charset=""utf-8"" />
    <title>Mail</title>
            ...
            <tr style=""height: 102px;"">
                <td style=""background: #ffffff; color: #000000; height: 29px; width: 660px;"" align=""center"" valign=""top"" bgcolor=""#ffffff"">
                    <table style=""border-top: 2px solid #3c87be; width: 660px;"" border=""0"" cellspacing=""0"" cellpadding=""0"">
                        <tbody>
                            <tr>
                                <td>You changes to the account had been saved! Good cooking!</td>
                            </tr>
                        </tbody>
                    </table>
                </td>
